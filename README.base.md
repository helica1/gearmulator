# gearmulator-md-mm (base project README)

> This is the README of [joelanders/gearmulator-md-mm](https://github.com/joelanders/gearmulator-md-mm), the project this
> branch is built on, kept as it was. For what this branch adds, see [README.md](README.md) and [ADDITIONS.md](ADDITIONS.md).
